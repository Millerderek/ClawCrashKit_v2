...
CREATE TABLE IF NOT EXISTS memory_entities (
    ...
    entity_name TEXT NOT NULL,                      -- e.g., 'EXAMPLE_CLIENT', 'Teams', 'SBC'
...
CREATE TABLE IF NOT EXISTS keyscores (
    ...
    composite_score REAL NOT NULL DEFAULT 0.5,       -- Weighted combination
...
-- Composite keyscore: weighted combination
-- Weights: recency=0.35, frequency=0.20, authority=0.30, entity_boost=0.15
